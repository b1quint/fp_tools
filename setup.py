...
setup(
    ...
    description='Some tools to deal with the SAM-FP data.',
    ...
    # Install the scripts that will be used
    scripts=['scripts/fp_repeat', 'scripts/fp_cut'],
)
